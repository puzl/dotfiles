...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; within a project.
   dotspacemacs-startup-lists '((recents-by-project . 5)
                                (recents . 5)
                                (projects . 7))
